...
void Decodificador::decodificadorYUVAndroidTCP(unsigned char* buffer_video, int tamanho_pacote) {
...
void Decodificador::decodificadorYUVAndroidMetade(unsigned char* buffer_video, int tamanho_pacote) {

	Mat myuv(height + height / 2, width, CV_8UC1, buffer_video);
...
void Decodificador::decodificadorMat(unsigned char* buffer_video, int tamanho_pacote) {
	//ReconhecedorFace * r = new ReconhecedorFace();
	...
	//salvarMat(frame_video);
	//r->detectarFace(frame_video);
	free(buffer_video);
}

void Decodificador::salvarMat(Mat img) {
